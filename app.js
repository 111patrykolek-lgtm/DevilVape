// Lista produktów (bestsellery)
const products = [
  {
    id: 1,
    name: "Inferno Mango",
    desc: "Soczyste mango z lodowym wykończeniem.",
    price: 39.9,
    rating: 4.9,
    reviews: 145,
    img: "img/inferno-mango.png"
  },
  {
    id: 2,
    name: "Crimson Berry",
    desc: "Mieszanka malin, jagód i czerwonych owoców.",
    price: 39.9,
    rating: 4.8,
    reviews: 129,
    img: "img/crimson-berry.png"
  },
  {
    id: 3,
    name: "Black Cherry Ice",
    desc: "Głęboka wiśnia z chłodzącym efektem.",
    price: 39.9,
    rating: 4.9,
    reviews: 112,
    img: "img/black-cherry.png"
  },
  {
    id: 4,
    name: "Golden Tobacco",
    desc: "Szlachetny tytoniowy smak o złotym charakterze.",
    price: 39.9,
    rating: 4.7,
    reviews: 98,
    img: "img/golden-tobacco.png"
  },
  {
    id: 5,
    name: "Frozen Devil Mint",
    desc: "Mocne, lodowe orzeźwienie z nutą mięty.",
    price: 39.9,
    rating: 4.9,
    reviews: 116,
    img: "img/frozen-devil.png"
  }
];
...
checkoutForm.addEventListener("submit", (e) => {
  e.preventDefault();
  alert("Zamówienie złożone! (w prawdziwej wersji tutaj byłoby przekierowanie do operatora płatności).");
  cart = [];
  saveCart();
  updateCartCount();
  renderCart();
